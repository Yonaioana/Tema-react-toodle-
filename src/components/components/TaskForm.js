            ...
            <div>
                {visible
                    ? <form onSubmit={createTask} className="noteTaskForm">
                            ...
                            <button type="submit" style={{background:"transparent",border:"none",marginLeft:"10px"}}>Save</button>
                            <button onClick={notVisibileForm} style={{background:"transparent",border:"none",marginLeft:"100px"}}>Cancel</button>
                        </form>
                    : null}
            </div>
        </div>
